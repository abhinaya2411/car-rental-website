          ...
          <div className="container py-5">
            <div className="row g-5 align-items-center">
              <div className="col-lg-6 text-center text-lg-start">
                <h1 className="display-4 text-dark mb-3 animated slideInLeft" data-aos="fade-right">
                  Find Your Perfect Car Today!
                </h1>
                <p className="text-dark mb-4 animated slideInLeft" data-aos="fade-right" data-aos-delay="200">
                  Quality vehicles, affordable prices, and seamless rental experience await you. Book now and hit the road with confidence!
                </p>
                <Link to="/cars" className="btn btn-primary py-2 px-4 me-3 animated slideInLeft" data-aos="fade-right" data-aos-delay="400">
                  Book A Car
                </Link>
                <Link to="/about" className="btn btn-outline-dark py-2 px-4 animated slideInLeft" data-aos="fade-right" data-aos-delay="600">
                  Learn More
                </Link>
              </div>
              <div className="col-lg-6 text-center text-lg-end">
                        ...
                        <div className="input-group">
                          ...
                          <select className="form-select ms-3">
                            {Array.from({ length: 8 }, (_, i) => (
                              <option key={i} value={i}>{`${i || 12}:00AM`}</option>
                            ))}
                          </select>
                        </div>
                      </div>
